    ...
    return (
        <Authenticated>
            ...
            <div className="overflow-x-auto py-12 space-y-9 px-3 md:px-12">
                <a href={route('blog_create')} className='bg-yellow-500 p-3 rounded-lg mt-5 absolute bottom-3 right-3 font-bold'>+ Create New</a>
                <div className="">
                        ...
                        <tbody>
                            <tr className="bg-white dark:bg-gray-800 border-t">
                                ...
                                <td className="py-4 px-6 flex gap-3 text-base">
                                    <a className='underline' href={route('blog')}>
                                        View
                                    </a>
                                    <AiOutlineShareAlt />
                                    <a className='' href={route('blog_edit')}>
                                        <FiEdit3 />
                                    </a>
                                    <MdOutlineDelete />
                                </td>
