            ...
            <section className='flex justify-center items-center'>
                <div className="p-4 w-full max-w-sm bg-white rounded-lg border shadow-md sm:p-8">
                    ...
                    <div className="grid items-baseline gap-1">
                        ...
                        <a href={route('payments.edit')} className='text-white bg-yellow-600 hover:bg-yellow-700 focus:ring-4 focus:outline-none focus:ring-yellow-200 font-medium rounded-lg text-sm mt-5 px-5 py-2.5 inline-flex justify-center w-full text-center'>
                            Edit
                        </a>
                    </div>
                </div>       
